...
```mermaid
    graph LR
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.v_spc_VSPCStructure("VSPCStructure(socialCircle.v_spc)")
        builtins_object("object(builtins)") --> builtins_type("type(builtins)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.v_spc_VSPCModel("VSPCModel(socialCircle.v_spc)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.v_spc_VSPCModel("VSPCModel(socialCircle.v_spc)")
        ...
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.trans_spc_TransformerSPCStructure("TransformerSPCStructure(socialCircle.trans_spc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.trans_spc_TransformerSPCModel("TransformerSPCModel(socialCircle.trans_spc)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.trans_spc_TransformerSPCModel("TransformerSPCModel(socialCircle.trans_spc)")
        builtins_object("object(builtins)") --> qpid.constant_PROCESS_TYPES("PROCESS_TYPES(qpid.constant)")
        ...
        qpid.__root.__baseObject_BaseObject("BaseObject(qpid.__root.__baseObject)") --> qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.ev_spc_EVSPCStructure("EVSPCStructure(socialCircle.ev_spc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.ev_spc_EVSPCModel("EVSPCModel(socialCircle.ev_spc)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.ev_spc_EVSPCModel("EVSPCModel(socialCircle.ev_spc)")
