...
```mermaid
    graph LR
        ...
        qpid.silverballers.interpHandlers.__baseInterpHandler__BaseInterpHandlerModel("_BaseInterpHandlerModel(qpid.silverballers.interpHandlers.__baseInterpHandler)") --> qpid.silverballers.interpHandlers.__direct_DirectHandlerModel("DirectHandlerModel(qpid.silverballers.interpHandlers.__direct)")
        builtins_object("object(builtins)") --> qpid.constant_INTERPOLATION_TYPES("INTERPOLATION_TYPES(qpid.constant)")
        qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)") --> qpid.silverballers.__baseArgs_SilverballersArgs("SilverballersArgs(qpid.silverballers.__baseArgs)")
        ...
        builtins_object("object(builtins)") --> qpid.constant_DATASET_CONFIGS("DATASET_CONFIGS(qpid.constant)")
        builtins_object("object(builtins)") --> qpid.constant_ARG_TYPES("ARG_TYPES(qpid.constant)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> qpid.applications.static_prediction_StaticModel("StaticModel(qpid.applications.static_prediction)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> qpid.applications.static_prediction_Static("Static(qpid.applications.static_prediction)")
        ...
        qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)") --> qpid.applications.linear_prediction_LinearArgs("LinearArgs(qpid.applications.linear_prediction)")
...
```mermaid
    graph LR
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.v_scp_VSCPlusStructure("VSCPlusStructure(socialCircle.v_scp)")
        builtins_object("object(builtins)") --> builtins_type("type(builtins)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.v_scp_VSCPlusModel("VSCPlusModel(socialCircle.v_scp)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.v_scp_VSCPlusModel("VSCPlusModel(socialCircle.v_scp)")
        qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)") --> socialCircle.original_models.__args_VArgs("VArgs(socialCircle.original_models.__args)")
        qpid.base.__baseManager_BaseManager("BaseManager(qpid.base.__baseManager)") --> qpid.training.__structure_Structure("Structure(qpid.training.__structure)")
        ...
        torch.nn.modules.module_Module("Module(torch.nn.modules.module)") --> socialCircle.__layers_PhysicalCircleLayer("PhysicalCircleLayer(socialCircle.__layers)")
        qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)") --> socialCircle.__args_PhysicalCircleArgs("PhysicalCircleArgs(socialCircle.__args)")
        torch.nn.modules.module_Module("Module(torch.nn.modules.module)") --> qpid.model.__model_Model("Model(qpid.model.__model)")
        qpid.base.__baseManager_BaseManager("BaseManager(qpid.base.__baseManager)") --> qpid.model.__model_Model("Model(qpid.model.__model)")
        builtins_object("object(builtins)") --> qpid.constant_INPUT_TYPES("INPUT_TYPES(qpid.constant)")
        torch.nn.modules.module_Module("Module(torch.nn.modules.module)") --> socialCircle.__layers_CircleFusionLayer("CircleFusionLayer(socialCircle.__layers)")
        qpid.base.__baseManager_BaseManager("BaseManager(qpid.base.__baseManager)") --> socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.v_sc_VSCStructure("VSCStructure(socialCircle.v_sc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.v_sc_VSCModel("VSCModel(socialCircle.v_sc)")
        ...
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.trans_scp_TransformerSCPlusStructure("TransformerSCPlusStructure(socialCircle.trans_scp)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.trans_scp_TransformerSCPlusModel("TransformerSCPlusModel(socialCircle.trans_scp)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.trans_scp_TransformerSCPlusModel("TransformerSCPlusModel(socialCircle.trans_scp)")
        builtins_object("object(builtins)") --> qpid.constant_PROCESS_TYPES("PROCESS_TYPES(qpid.constant)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.trans_sc_TransformerSCStructure("TransformerSCStructure(socialCircle.trans_sc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.trans_sc_TransformerSCModel("TransformerSCModel(socialCircle.trans_sc)")
        ...
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.original_models.v_VBModel("VBModel(socialCircle.original_models.v)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.original_models.v_VB("VB(socialCircle.original_models.v)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.original_models.v_VAModel("VAModel(socialCircle.original_models.v)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.original_models.v_VA("VA(socialCircle.original_models.v)")
        torch.nn.modules.module_Module("Module(torch.nn.modules.module)") --> qpid.model.transformer._transformer_Transformer("Transformer(qpid.model.transformer._transformer)")
        builtins_object("object(builtins)") --> qpid.constant_ANN_TYPES("ANN_TYPES(qpid.constant)")
        ...
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.original_models.msn_MSNAlphaModel("MSNAlphaModel(socialCircle.original_models.msn)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.original_models.msn_MSNAlpha("MSNAlpha(socialCircle.original_models.msn)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.original_models.ev_EVModel("EVModel(socialCircle.original_models.ev)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.original_models.ev_EV("EV(socialCircle.original_models.ev)")
        qpid.__root.__baseObject_BaseObject("BaseObject(qpid.__root.__baseObject)") --> qpid.__root.__argsManager_ArgsManager("ArgsManager(qpid.__root.__argsManager)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.msn_scp_MSNSCPlusStructure("MSNSCPlusStructure(socialCircle.msn_scp)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.msn_scp_MSNSCPlusModel("MSNSCPlusModel(socialCircle.msn_scp)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.msn_scp_MSNSCPlusModel("MSNSCPlusModel(socialCircle.msn_scp)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.msn_sc_MSNSCStructure("MSNSCStructure(socialCircle.msn_sc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.msn_sc_MSNSCModel("MSNSCModel(socialCircle.msn_sc)")
        ...
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.ev_scp_EVSCPlusStructure("EVSCPlusStructure(socialCircle.ev_scp)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.ev_scp_EVSCPlusModel("EVSCPlusModel(socialCircle.ev_scp)")
        socialCircle.__base_BaseSocialCircleModel("BaseSocialCircleModel(socialCircle.__base)") --> socialCircle.ev_scp_EVSCPlusModel("EVSCPlusModel(socialCircle.ev_scp)")
        qpid.training.__structure_Structure("Structure(qpid.training.__structure)") --> socialCircle.ev_sc_EVSCStructure("EVSCStructure(socialCircle.ev_sc)")
        qpid.model.__model_Model("Model(qpid.model.__model)") --> socialCircle.ev_sc_EVSCModel("EVSCModel(socialCircle.ev_sc)")
